...
import { Users, Landmark, Clock, AlertTriangle, Coins, TrendingUp } from "lucide-react";
...
async function getStats() {
  ...
  return {
    ...
    feeRevenue: feeRevenueSnap.data().totalFees ?? 0,
  };
}
...
export default async function AdminOverviewPage() {
  ...
  const cards = [
    ...
    { label: "Fee revenue (all time)", value: `$${(stats.feeRevenue / 100).toLocaleString()}`, icon: TrendingUp },
